...
const StarSort = ({starCount, toggle, starFilter, reset}) => {
  ...
  console.log('SORTING: ', sort)
    ...
    return (
      <div>
        {map}
          {sort && <SortDisplay>Sorting by {sort.slice(0, sort.length-2)} star reviews</SortDisplay>}
          {(starFilter['1'] || starFilter['2'] || starFilter['3'] || starFilter['4'] || starFilter['5']) && <Reset onClick={reset}>Reset Sort</Reset>}
      </div>
    );
}
